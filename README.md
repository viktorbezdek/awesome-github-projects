...
- [ajayrandhawa/Keylogger](https://github.com/ajayrandhawa/Keylogger) - Keylogger is 100% invisible keylogger not only for users, but also undetectable by antivirus software. Blackcat keylogger Monitors all keystokes, Mouse clicks. It has a seperate process which continue
...
- [vaticle/typedb-driver-examples](https://github.com/vaticle/typedb-driver-examples) - TypeDB Driver Example Projects and Tutorials
...
- [vaticle/typeql](https://github.com/vaticle/typeql) - TypeQL: the polymorphic query language of TypeDB
...
- [itflow-org/itflow](https://github.com/itflow-org/itflow) - Free and open-source web application for MSPs that streamlines IT documentation, ticketing, invoicing, and accounting, an alternative to ITGlue. It helps in managing and organizing client's IT informa
...
- [mackenziefernandez/recipe-parser](https://github.com/mackenziefernandez/recipe-parser) - Natural language parser for recipes and lists of ingredients
...
- [falsy/react-with-clean-architecture](https://github.com/falsy/react-with-clean-architecture) - Clean architecture based react project sample code.
...
- [j0lv3r4/next-authentication](https://github.com/j0lv3r4/next-authentication) - Authentication & Authorization library for the Next.js framework
...
- [epicweb-dev/advanced-react-hooks](https://github.com/epicweb-dev/advanced-react-hooks) - Learn Advanced React Hooks workshop
