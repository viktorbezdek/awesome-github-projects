...
- [falsy/clean-architecture-with-typescript](https://github.com/falsy/clean-architecture-with-typescript) - A sample project for adopting Clean Architecture in a TypeScript-based service.
